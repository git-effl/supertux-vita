...
<p align="center">A PSVita port of SuperTux,version 0.40.</p>
...
```bash
git clone --recursive https://github.com/git-effl/supertux-vita.git
```
...
2. Put it on your Vita's Memory Card (or SD2Vita)
